...
CJ 고객번호 분기:
  - A (CJ_CUST_ID):   30494329  넥스원프레시     → line_code=4 (외부송장)
  - B (CJ_CUST_ID_B): B133030971 넥스원프레시아이스 → line_code=0~3 (1단/2단/3단/큐브)
"""
import logging
import os
import time
...
# line_code 0~3: 넥스원 출고 (아이스) → CJ_CUST_ID_B
# line_code 4+:  외부 송장            → CJ_CUST_ID (A)
EXTERNAL_LINE_CODE = 4  # 외부송장 line_code
