...
PAGE_REGISTRY = [
    ...
    ('bank_mgmt',      '은행 관리',      'bi-bank2',              '/bank/',               ['admin','general'],                                                '총무/경리'),
    ('bank_transactions','은행 거래',    'bi-bank',               '/bank/transactions',   ['admin','general'],                                                '총무/경리'),
    ('bank_upload',    '엑셀 업로드',    'bi-file-earmark-excel', '/bank/upload',         ['admin','general'],                                                '총무/경리'),
    ('tax_invoices',   '세금계산서',     'bi-receipt',            '/tax-invoice/',        ['admin','general'],                                                '총무/경리'),
    ('matching',       '매출-입금 매칭', 'bi-link-45deg',         '/accounting/matching', ['admin','general'],                                                '총무/경리'),
    ...
    ('marketplace_ship','송장관리',     'bi-truck',              '/marketplace/shipping', ['admin','general'],                                                     '관리'),
